...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./ToQyo.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("DRG", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S ToQyo -X kill
screen -S ToQyo ./ToQyo
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/TEAM-ToQyo/Files_ToQyo/main/File_Bot/commands.lua") 
...
local ToQyo_Msg = ''  
if msgs < 100 then 
ToQyo_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
ToQyo_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
ToQyo_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
ToQyo_Msg = 'متفاعل' 
elseif msgs < 1200 then 
ToQyo_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
ToQyo_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
ToQyo_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
ToQyo_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
ToQyo_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
ToQyo_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
ToQyo_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
ToQyo_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
ToQyo_Msg = 'رب التفاعل'  
end 
return ToQyo_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"◈︙[Ch Source](t.me/zz_zzzz)")  
...
--------------------------------------------------------------------------------------------------------------
function SourceToQyo(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,ToQyo_Msg) 
return false  
end 
if text then    
...
os.execute('wget https://raw.githubusercontent.com/TEAM-ToKyo/ToQyo/main/ToQyo.lua')
...
send(msg.chat_id_, msg.id_,'◈︙  عدد الكروبات الان » { '..#group..' }'..ToQyok..''..ToQyo..'\n◈︙  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
local ToQyo1_Msg = database:get(bot_id.."ToQyo1:Add:Filter:Rp2"..text..msg.chat_id_)   
if ToQyo1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◈︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Zz_ZzZz')..') \n ◈︙ '..ToQyo1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if ToQyo_Msg and not Special(msg) then  
local ToQyo_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if ToQyo_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ◈︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ◈︙ ["..ToQyo_Msg.."] \n")
else
send(msg.chat_id_,0," ◈︙ العضو : {["..data.first_name_.."](T.ME/Zz_ZzZz)}\n ◈︙ ["..ToQyo_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ◈︙ عذرا » {["..data.first_name_.."](T.ME/Zz_ZzZz)}\n ◈︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:sadd(bot_id.."ToQyo:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."ToQyo:blocname"..msg.chat_id_)
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."ToQyo:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."ToQyo:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."ToQyo:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."ToQyo:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."ToQyo:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."ToQyo:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."ToQyo:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."ToQyo:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."ToQyo:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."ToQyo:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."ToQyo:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "◈︙ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "Zz_ZzZz")..")\n◈︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."ToQyo:teh"..msg.chat_id_).."} بجانب اسمك\n◈︙ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local ToQyoChengName = database:get(bot_id.."ToQyo:Cheng:Name"..data.id_)
if not data.first_name_ then 
if ToQyoChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..ToQyoChengName..']')
database:del(bot_id.."ToQyo:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if ToQyoChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."ToQyo:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local ToQyoChengUserName = database:get(bot_id.."ToQyo:Cheng:UserName"..data.id_)
if not data.username_ then 
if ToQyoChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..ToQyoChengUserName..']')
database:del(bot_id.."ToQyo:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if ToQyoChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."ToQyo:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local ToQyoChengPhoto = database:get(bot_id.."ToQyo:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if ToQyoChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."ToQyo:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if ToQyoChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."ToQyo:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
◈︙ TEAM TOQYO 
— — — — — — — — —
◈︙ [Source Channel](t.me/Zz_ZzZz)

◈︙ [Source Update ](t.me/ToQyo)     

◈︙ [Source developer](t.me/ijiiii)     

◈︙ [Tumbelr Source](t.me/YFFFY) 
— — — — — — — — —
𓂅 . [TWS ToQyo](t.me/QQMBOT)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ◈︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Zz_ZzZz')..') \n ◈︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◈︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Zz_ZzZz')..') \n ◈︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TEAM-ToQyo/ToQyoFiLe/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ◈︙ اهلا بك في متجر ملفات طوكيو\n ◈︙ ملفات السورس ↓\n— — — — — —  — — — —\n\n"
local TextE = "\n— — — — — —  — — — —\n ◈︙ علامة تعني { ✔️ } ملف مفعل\n ◈︙ علامة تعني { ✖ } ملف معطل\n ◈︙ قناة سورس طوكيو ↓\n".." ◈︙ [اضغط هنا لدخول](t.me/Zz_ZzZz) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ◈︙ لا يوجد ملفات في السورس\n") 
end
return false
end
end
...
local json_file, res = https.request("https://raw.githubusercontent.com/TEAM-ToQyo/ToQyoFiLe/main/File_Bot/"..file)
if res == 200 then
...
local UserName = (b.username_ or "TEAM-ToQyo")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ◈︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Zz_ZzZz')..')'
status  = '\n ◈︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ◈︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ◈︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Zz_ZzZz')..')'
...
database:set(bot_id.."ToQyo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."ToQyo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ◈︙ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."ToQyo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."ToQyo1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."ToQyo1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."ToQyo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ◈︙ تم منع الكلمه مع التحذير")  
database:del(bot_id.."ToQyo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."ToQyo1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."ToQyo1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."ToQyo1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ◈︙ ارسل الكلمه الان")  
database:set(bot_id.."ToQyo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."ToQyo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."ToQyo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ToQyo1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."ToQyo1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."ToQyo1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."ToQyo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ToQyo1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."ToQyo1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ◈︙ قائمة المنع \n— — — — — —  — — — —\n"
for k,v in pairs(list) do  
local ToQyo_Msg = database:get(bot_id.."ToQyo1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..ToQyo_Msg.."}\n"    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,'['..ToQyo_Msg[math.random(#ToQyo_Msg)]..']') 
return false
end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:ToQyo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ◈︙ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:ToQyo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:ToQyo:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:ToQyo:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:ToQyo:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"◈︙ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:ToQyo:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:ToQyo:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:ToQyo:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:ToQyo:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:ToQyo:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:ToQyo:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:ToQyo:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:ToQyo:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:ToQyo:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:ToQyo:List:Rd:Sudo")
end
...
database:set(bot_id.."Zz_ZzZz:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."Zz_ZzZz:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."Zz_ZzZz:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Zz_ZzZz:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"◈︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."Zz_ZzZz:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."Zz_ZzZz:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس طوكيو يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:ToQyo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:ToQyo:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"◈︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:ToQyo:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:ToQyo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:ToQyo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:ToQyo:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:ToQyo:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:ToQyo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:ToQyo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:ToQyo:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:ToQyo:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:ToQyo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:ToQyo:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:ToQyo:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"◈︙تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:ToQyo:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:ToQyo:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:ToQyo:Add:Rd:Sudo:Text2"..text)   
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'طوكيو').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Zz_ZzZz')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
ToQyodx(msg.chat_id_, msg.id_, ' ◈︙ ايدي المجموعة » ( '..msg.chat_id_..' )\n ◈︙ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ◈︙ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ◈︙ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
ToQyo = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(ToQyo)
...
--------------------------------------------------------------------------------------------------------------
SourceToQyo(data.message_,data)
plugin_ToQyo(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local ToQyoAbot = database:get(bot_id.."ToQyo1:Add:Filter:Rp2"..text..result.chat_id_)   
if ToQyoAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ◈︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ◈︙ ["..ToQyoAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local ToQyo1_Msg = database:get(bot_id.."ToQyo1:Add:Filter:Rp2"..text..result.chat_id_)   
if ToQyo1_Msg then    
send(msg.chat_id_, msg.id_," ◈︙ "..ToQyo1_Msg)
